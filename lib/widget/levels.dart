            ...
            children: [
              Container(
               ...
               Positioned(
                ...
                child: Row(
                  children: [
                    Icon(Icons.star, color: (levelCubit.starsNumber >=1 ? Colors.yellow : Colors.yellow.withOpacity(.5) )),
                    Icon(Icons.star, color: (levelCubit.starsNumber >=2 ? Colors.yellow : Colors.yellow.withOpacity(.5) )),
                    Icon(Icons.star, color: (levelCubit.starsNumber >=3 ? Colors.yellow : Colors.yellow.withOpacity(.5) )),
                  ],
                ),
              ),
            ],
