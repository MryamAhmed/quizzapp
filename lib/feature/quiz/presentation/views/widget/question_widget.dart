...
import 'package:quizzles/feature/quiz/presentation/manager/quizz/quiz_cubit.dart';
...
class ChoiceQuestionsListView extends StatefulWidget {
  ChoiceQuestionsListView(
      {Key? key,
      required this.incorrectAnswersList,
...
class _ChoiceQuestionsListViewState extends State<ChoiceQuestionsListView> {
  ...
  void initState() {
    ...
    allAnswers = quizCubit.MakeACombleteList(
